    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!--link đến trang danh sách sản phẩm -->
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex"> --}}
                {{-- <a>Sản phẩm</a> --}}
                ...
                <!--link đến trang danh sách thể loại -->
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex"> --}}
                {{-- <a>Thể loại</a> --}}
                {{-- <x-nav-link :href="route('cate.index')" :active="request()->routeIs('cate.index')">
                        {{ __('Thể loại') }}
                    </x-nav-link> --}}
                {{-- </div> --}}

                <!--link đến trang danh sách thành viên -->
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex"> --}}
                {{-- <a>Thành viên</a> --}}
